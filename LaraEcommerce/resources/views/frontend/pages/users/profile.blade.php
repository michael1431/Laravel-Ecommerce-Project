...
<div class="container">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('user.profile.update') }}" class="mb-5">
          @csrf
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <textarea id="shipping_address" rows="4" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address"   autocomplete="shipping_address">{{ $user->shipping_address}}</textarea>
